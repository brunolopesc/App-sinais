...
function criarWidget(container, symbol) {
  container.innerHTML = "";
  ...
  titulo.style.cssText = "font-weight:700;font-size:13px;margin-bottom:6px;padding:0 4px;";
  titulo.textContent = symbol.label;
  ...
  script.src = "https://s3.amazonaws.com/tradingview-widget-shopping-cart/embed-widget-technical-analysis.js";
  script.async = true;
